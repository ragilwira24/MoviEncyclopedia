...
public class ComingSoonService {
    ...
    public static void comingSoonItems(View view, RecyclerView recyclerView, ComingSoonAdapter adapter, List<Result> results, FragmentActivity fragmentActivity){
        ...
        fetchComingSoonItems(results, adapter, view);
    }

    private static void fetchComingSoonItems(final List<Result> results, final ComingSoonAdapter adapter, View view){

        final RelativeLayout relativeLayout = view.findViewById(R.id.upcomingSectionPB);

        String url = MoviesUrlConstant.getUpcomingUrl() + "?api_key="+ CommonConstant.getApiKey() + "&language=en-US";
