...
public class NowPlayingService {
    ...
    public static void showNowPlayingItems(View view, RecyclerView recyclerView, NowPlayingAdapter adapter, List<Result> results, FragmentActivity fragmentActivity){
        ...
        fetchNowPlayingItems(results, adapter, view);
    }

    private static void fetchNowPlayingItems(final List<Result> results, final NowPlayingAdapter adapter, View view){

        final RelativeLayout relativeLayout = view.findViewById(R.id.nowPlayingSectionPB);

        String url = MoviesUrlConstant.getNowPlayingUrl() + "?api_key="+ CommonConstant.getApiKey() + "&language=en-US";
