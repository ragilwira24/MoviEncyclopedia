...
public class OngoingTvService {

    public static void ongoingTvItems(View view, RecyclerView recyclerView, OngoingTvAdapter adapter, List<Result> results, FragmentActivity fragmentActivity){
        recyclerView = view.findViewById(R.id.comingSoonRV);
        ...
        fetchOngoingTvItems(results, adapter, view);
    }

    private static void fetchOngoingTvItems(final List<Result> results, final OngoingTvAdapter adapter, View view){

        final RelativeLayout relativeLayout = view.findViewById(R.id.onTvSectionPB);

        String url = TvUrlConstant.getOnTheAirUrl() + "?api_key="+ CommonConstant.getApiKey() + "&language=en-US";
